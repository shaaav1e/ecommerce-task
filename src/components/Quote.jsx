...
const Quote = () => {
  return (
    <div className="mt-4">
      <div className="bg-white container rounded-md">
        <div className="flex justify-between bg rounded-md overflow-hidden">
          <div className="w-1/2 flex flex-col gap-3 px-12 py-10 text-white">
          ...
          {/* Form */}
          <div className="bg-white text-black rounded-lg shadow-md p-8 mx-6 my-6 w-1/3">
